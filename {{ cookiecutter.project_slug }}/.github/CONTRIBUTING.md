...
Please send the related information to [jcook3701's email](mailto:jcook3701+{{ cookiecutter.project_slug }}@gmail.com?subject=Report:%20Security%20Vulnerability).
...
7. Follow the link posted by the, {{ cookiecutter.project_name }}, project to your pull request and accept it, as described in detail above.
